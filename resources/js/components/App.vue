        ...
        <div class="flex" >
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-300 " >
                <nav class="pt-4">
                    ...
                    <router-link to="/contacts/create" :class="{'selected-menu': namedLink == 'newContact' }" class="flex items-center py-2 hover:text-blue-600 hover:bg-gray-200" >
                    ...
                    <router-link to="/contacts" :class="{'selected-menu': namedLink == 'contacts' }" class="flex items-center py-2 hover:text-blue-600 hover:bg-gray-200" >
                    ...
                    <router-link to="/birthdays" :class="{'selected-menu': namedLink == 'birthdays' }" class="flex items-center py-2 hover:text-blue-600 hover:bg-gray-200" >
                    ...
                    <router-link to="/logout" class="flex items-center py-2 hover:text-blue-600 hover:bg-gray-200" >
...
export default {
    ...
    created(){
        ...
        this.namedLink = this.$route.name;
    ...
    watch: {
        $route(to, from){
            ...
            this.namedLink = to.name;
        },
        title(val){
            document.title = this.title + ' | SPA Contacts with Vue and Laravel '
        }
    }
