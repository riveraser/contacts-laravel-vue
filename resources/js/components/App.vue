    ...
    <div class="h-screen bg-white">
        <div class="flex" >
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-300 " >
                <nav class="pt-4">
                    <router-link to="/" ><img src="/img/iconoSR32.png" alt="SR" width="32" class="shadow inline-block" ></router-link>
            ...
            <div class="flex flex-col flex-1 h-screen overflow-y-hidden" >
                <div class="h-16 p-6 border-b border-gray-400 flex items-center justify-between bg-gray-100 " >
                    <div>Contacts</div>
                    <div class="rounded-full uppercase font-bold text-blue-500 bg-blue-200 w-10 h-10 flex justify-center items-center border border-blue-300 shadow " >SR</div>
                </div>
